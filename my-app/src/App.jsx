        ...
        <header className="h-20 bg-white/60 backdrop-blur-xl border-b border-slate-200/60 px-4 sm:px-8 flex items-center justify-between sticky top-0 z-10">
          ...
          <div className="relative">
            ...
            <button 
              ...
              className="flex items-center gap-3 hover:bg-slate-100/50 p-1.5 pr-2 rounded-xl transition-colors focus:outline-none focus:ring-2 focus:ring-indigo-500/20"
            >
              ...
              <svg xmlns="http://www.w3.org/2000/svg" className={`h-4 w-4 text-slate-400 transition-transform ${isProfileDropdownOpen ? 'rotate-180' : ''}`} fill="none" viewBox="0 0 24 24" stroke="currentColor">
            ...
            {isProfileDropdownOpen && (
              <>
                ...
                />
                <div className="absolute right-0 mt-2 w-48 bg-white rounded-xl shadow-xl border border-slate-100 py-2 z-40 animate-in fade-in slide-in-from-top-2 duration-200">
                  <div className="px-4 py-2 border-b border-slate-100 mb-2">
                    <p className="text-sm font-medium text-slate-900 truncate">{userProfile.firstName} {userProfile.lastName}</p>
